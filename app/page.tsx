      ...
      <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="border-t border-gray-200 pt-12 sm:pt-16">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black mb-8 sm:mb-12 tracking-tight">
              WHAT'S HOT?
            </h2>
                ...
                <CarouselContent className="gap-4">
                  <CarouselItem className="basis-1/5 min-w-0">
                    <div className="group cursor-pointer">
                      <div className="aspect-[4/5] bg-gray-100 overflow-hidden mb-4">
                        <img
                          src="/cricket-player-blue-jersey.png"
                          alt="Cricket"
                  ...
                  <CarouselItem className="basis-1/5 min-w-0">
                    <div className="group cursor-pointer">
                      <div className="aspect-[4/5] bg-gray-100 overflow-hidden mb-4">
                        <img
                          src="/soccer-player-white-jersey.png"
                          alt="Football"
                          className="w-full h-full object-cover"
                        />
                      </div>
                  ...
                  <CarouselItem className="basis-1/5 min-w-0">
                    <div className="group cursor-pointer">
                      <div className="aspect-[4/5] bg-gray-100 overflow-hidden mb-4">
                        <img
                          src="/basketball-player-athletic-wear.png"
                          alt="Basketball"
                          className="w-full h-full object-cover"
                        />
                      </div>
